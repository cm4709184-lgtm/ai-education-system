/**
 * @file    main.h
 * @brief   离线语音控制小车 — 主头文件 (系统状态/指令定义/任务声明)
...
extern volatile CarCommand_t  car_command;
extern volatile float         ultrasonic_distance;
extern volatile float         last_confidence;
extern volatile uint32_t      last_inference_us;
extern volatile char          last_inference_label[24];
extern volatile char          last_confirmed_label[24];
...
#define oled_Pin GPIO_PIN_11
#define oled_GPIO_Port GPIOE
#define oledE12_Pin GPIO_PIN_12
#define oledE12_GPIO_Port GPIOE
